...
namespace Programlar
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            {
                sorgu.CommandText = "INSERT INTO " + Environment.MachineName + "(program,tarih,saat)" + "VALUES('" + MicrosoftProgramları.Items[i].ToString() + "','" + Convert.ToDateTime(dateTimePicker1.Text) + "','" + label1.Text + "')";
